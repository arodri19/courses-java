...
//		assertThrows(IllegalArgumentException.class, () -> service.calcularBonus(new Funcionario("Andre", LocalDate.now(), new BigDecimal("25000"))));
...
//		assertEquals(new BigDecimal("0.00"), bonus);
	...
	void bonusDeveriaSer10PorCentoDoSalario() {
		BonusService service = new BonusService();
		BigDecimal bonus = service.calcularBonus(new Funcionario("Andre", LocalDate.now(), new BigDecimal("2500")));
